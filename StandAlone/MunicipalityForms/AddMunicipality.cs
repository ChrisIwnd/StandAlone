...
namespace StandAlone.Municipality
{
    public partial class AddMunicipality : Form
    {
        ...
        /// </summary>
        string SqlExec = "INSERT INTO municipality VALUES('{0}','{1}')";
        ...
        {
            if (string.IsNullOrWhiteSpace(TbxMunicipality.Text) || string.IsNullOrEmpty(CmbProvince.Text))
            {
            ...
            {
                DCom.Exec(String.Format(SqlExec, this.TbxMunicipality.Text, this.CmbProvince.SelectedValue));
